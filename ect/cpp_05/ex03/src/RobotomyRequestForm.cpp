...
/*   Updated: 2023/05/01 21:34:45 by seoyoo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void RobotomyRequestForm::robotomize() const
{
    ...
    std::cout << "\033[31;40m" << "Operation started" << "\033[0m" << std::endl;
    ...
    if (operation_result == true)
        std::cout << "\033[31;40m" << target_ << " has been robotomized successfully!!" << "\033[0m" << std::endl;
    else
        std::cout << "\033[31;40m" << "Operation fail......" << "\033[0m" << std::endl;
}
